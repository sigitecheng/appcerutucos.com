<div id="popular-fundrising" class="mt-8" style="display: flex; flex-direction: column; align-items: center;">
    ...
    <div class="px-4 flex justify-center items-center" style="display: flex; justify-content: center; align-items: center;">
        <a href="/comingsoon" style="margin-left: 2px; margin-right: 2px;">
            <h5 class="font-semibold ml-2 mr-2 text-sm" style="font-weight: 600; font-size: 0.875rem;">Cos</h5>
        </a>
        <p>|</p>
        <a href="/comingsoon" style="margin-left: 2px; margin-right: 2px;">
            <h5 class="font-semibold ml-2 mr-2 text-sm" style="font-weight: 600; font-size: 0.875rem;">Coeroetoe Oerang Soenda</h5>
        </a>
        <p>|</p>
        <a href="/comingsoon" style="margin-left: 2px; margin-right: 2px;">
            <h5 class="font-semibold ml-2 mr-2 text-sm" style="font-weight: 600; font-size: 0.875rem;">Indonesia</h5>
        </a>
    </div>
    ...
    {{-- </div> --}}
            ...
            <div class="flex items-center">
                <div class="w-10 h-10 flex shrink-0">
                   <img src="/assets/gambardepan/iconcos2.png" alt="icon">
                </div>               
           </div>
